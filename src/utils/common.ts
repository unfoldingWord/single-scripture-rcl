...
// messages
export const MANIFEST_NOT_FOUND_ERROR_MSG = 'This project manifest failed to load.  Please confirm that the correct manifest.yaml file exists in the project at:\n'
export const MANIFEST_INVALID_ERROR_MSG = 'The manifest for this project is invalid.  Project is at:\n'
export const BOOK_NOT_FOUND_ERROR_MSG = 'This book can not be found in the project.  Project is at:\n'
export const SCRIPTURE_NOT_FOUND_ERROR_MSG = 'There is no associated content for this verse.  Project is at:\n'
